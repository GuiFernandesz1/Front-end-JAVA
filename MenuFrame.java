...
{ // 'private' uso exclusivo a classe, 'final' somente leitura, '[]' matriz
   ...
   private final JRadioButtonMenuItem[] colorItems;  // cores
   private final JRadioButtonMenuItem[] fonts;  // fontes
   private final JRadioButtonMenuItem[] sizes;  // tamanhos
   private final JCheckBoxMenuItem[] styleItems; 
   private final JLabel displayJLabel; 
   private final ButtonGroup fontButtonGroup; 
   private final ButtonGroup colorButtonGroup; // grupo de botões

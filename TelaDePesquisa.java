...
public class TelaDePesquisa extends JFrame {
    ...
    public TelaDePesquisa() {
        ...
        txtId.setEditable(false); // código utilizado para evitar que o usuário consiga editar o campo selecionado, apenas copiar.
        linhaId.add(lblId);
        linhaId.add(txtId);
        add(linhaId);
        ...
        txtNome.setEditable(false); // código utilizado para evitar que o usuário consiga editar o campo selecionado, apenas copiar.
        ...
        txtEmail.setEditable(false); // código utilizado para evitar que o usuário consiga editar o campo selecionado, apenas copiar.
